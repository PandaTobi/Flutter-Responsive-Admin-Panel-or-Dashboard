    ...
    return Card(
      ...
      child: Container(
        ...
        child: InkWell(
          onTap: () {
            if (index == 0) {
              Navigator.push(context, MaterialPageRoute(builder: (context) => new FaceDetectorView()));
            }
            if (index == 1) {
              //2.item
              Navigator.push(context, MaterialPageRoute(builder: (context) => new AdminStudentScreen()));
            }
            if (index == 2) {
              Navigator.push(context, MaterialPageRoute(builder: (context) => new AdminClassesScreen()));
            }
            if (index == 3) {
              //4.item
            }
